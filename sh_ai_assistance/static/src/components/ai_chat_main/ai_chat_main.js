...
export class AiChatMainComponent extends Component {
    ...
    async onShareSession() {
        ...
        if (this.state.currentSession.message_count === 0) {
            this.notification.add("Cannot share an empty chat.", { type: "warning" });
            return;
        }
    ...
    async onExportChat() {
        ...
        if (this.state.currentSession.message_count === 0) {
            this.notification.add("Cannot export an empty chat.", { type: "warning" });
            return;
        }
