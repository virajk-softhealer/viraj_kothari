...
export class AiOnboardingWizard extends Component {
    ...
    selectProvider(provider) {
        ...
        // If the provider already has a key in the base module, 
        // pre-fill the API key field with the actual key.
        if (provider.has_key) {
            this.state.apiKey = provider.api_key;
            this.state.verifySuccess = 'Existing API key detected from system settings.';
        }
    }
