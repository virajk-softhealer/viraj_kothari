...
export class AiChatContentComponent extends Component {
    ...
    setup() {
        ...
        this.busService.subscribe("sh_ai_assistance/processing_status", (status) => {
    ...
    get currentUser() {
        return {
            ...
            name: this.store.self?.main_user_id?.name || session.partner_display_name || session.name || 'User',
        };
    }
