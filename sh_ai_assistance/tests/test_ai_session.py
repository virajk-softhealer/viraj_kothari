...
class TestAiSession(TransactionCase):
    ...
    def test_base_engine_build_result_includes_reasoning_tokens(self):
        """Reasoning token usage must survive final result packaging."""
        engine = BaseAiEngine(self.env)
        ...
        result = engine._build_result(context, "Reasoned answer")
